...
.. option:: "oiio:ColorSpace" : string
    ...
    - `"lin_rec709_scene"`,  :  Color pixel values are known to be linear
      ...
      `"lin_rec709"` and `"linear"` are treated as synonyms.
    - `"lin_ap1_scene"`, `"ACEScg"` :  ACEScg color space encoding.
    - `"lin_ap0_scene"`, `"ACES"` :  ACES.
    - `"srgb_rec709_display"` : Using standard sRGB response and primaries.
    ...
    - `"g18_rec709_display"` : Rec709/sRGB primaries, but using a response curve
