...
enum class BaseType : uint8_t {
    ...
    UINT32,             ///< 32-bit unsigned int values
    INT32,              ///< signed 32-bit int values
    UINT64,             ///< 64-bit unsigned int values
    INT64,              ///< signed 64-bit int values
    HALF,               ///< 16-bit IEEE floating point values
...
struct OIIO_UTIL_API TypeDesc {
    ...
    enum BASETYPE {
        ...
        VOID = uint8_t(BaseType::VOID),
        NONE = uint8_t(BaseType::VOID),  // obsolete synonym
